...
const WavelengthData = require("./dataHandlerWavelength.js");
const WavelengthSockets = require("./socketsWavelength.js");


let wavelengthData = new WavelengthData();
wavelengthData.initializeData();

var io = require('socket.io')(http, {cookie: false});

io.on('connection', function (socket) {
  WavelengthSockets(this, socket, wavelengthData);
});
